...
},{"./is-function":3,"./is-object":4,"./request-base":5,"./response-base":6,"emitter":1}],3:[function(require,module,exports){
/**
...
var btn = document.getElementsByClassName("jobs__delete");

var deleteData = function deleteData() {
  var el = this.parentNode;
  if (confirm("delete?")) {
    request.post("/delete").send({ id: el.getAttribute("data-id") }).type("form").end(function (err, res) {
      if (err) {
        console.log("error");
      } else {
